...
// 3. Avoid going if the bar is already trending upward.
  ...
  [BuiltInAgentType.THRESHOLD]: {
    ...
    parameters: [
      ...
      },
      {
        key: 'goProbability',
        label: 'goProbability',
        description: 'Вероятность пойти при соблюдении порога.',
        defaultValue: 0.8,
        min: 0,
        max: 1,
        step: 0.05,
    ...
    parameters: [
      {
        key: 'windowSize',
        label: 'windowSize',
        description: 'Длина окна по истории посещаемости.',
        defaultValue: 5,
        min: 1,
        max: 50,
        step: 1,
      ...
      },
      {
        key: 'threshold',
        label: 'threshold',
        description: 'Порог для среднего по окну.',
        defaultValue: 0.6,
        min: 0,
        max: 2,
        step: 0.05,
    ...
    parameters: [
      {
        ...
        description: 'Стартовый порог агента.',
        defaultValue: 0.6,
        min: 0,
        max: 1,
        step: 0.05,
    ...
    parameters: [
      {
        key: 'lookback',
        label: 'lookback',
        description: 'Сколько последних раундов усреднять (размер окна).',
        defaultValue: 1,
        min: 1,
        max: 50,
        step: 1,
