      ...
      <div>
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <p className="text-sm text-black-500 mb-4">
            Классическая модель поведения агентов в условиях отсутствия детерминированной оптимальной стратегии
          </p>
        ...
        <div className="space-y-8 text-black-700">
          <p className="text-sm text-gray-600">
            Подробнее узнать об интерфейсе с разбором кейсов: <a
        ...
        <section>
          ...
          <p>
            ...
            можно наслаждаться, если в нем меньше, чем [capacity]% от общего числа студентов.
              ...
              return (
                <div key={preset.label} className="bg-white rounded-lg border border-gray-200 p-4">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    <p>
                      <span className="font-medium text-gray-900">Правило: </span>
                      <span className="block mt-1 overflow-x-auto rounded border border-gray-100 bg-gray-50 px-2 py-1 text-gray-800">
                        <MathJax dynamic>{`\\(${preset.formulaTex}\\)`}</MathJax>
                      </span>
                    </p>
                    <p>
