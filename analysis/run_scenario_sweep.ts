...
import { SimulationEngine, AgentFactory, AgentSandbox } from '../apps/backend/src/core/simulation-engine/index.ts';
...
function runScenario(definition: ScenarioDefinition) {
  ...
  return {
    ...definition,
    rounds: result.rounds.map((round: { roundNumber: number; attendance: number; totalBenefit: number }) => ({
